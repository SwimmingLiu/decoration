...
public class AgreementPretreatment {
	...
	public final static <T> void ListReferenceAgreementPretreatment( OutputStream out , List< DataConversion > list , List<Object> objectList ,int num ,
		KeyCreate< Object > keyCreate) throws IOException{
