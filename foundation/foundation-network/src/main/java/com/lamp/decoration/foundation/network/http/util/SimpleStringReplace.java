package com.lamp.decoration.foundation.network.http.util;

import com.lamp.foundation.api.StringReplace;
...
public class SimpleStringReplace implements StringReplace {

    private final List<Paragraph> paragraphList = new ArrayList<>();


    public SimpleStringReplace(String data) {
