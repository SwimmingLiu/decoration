...
public class OperationsEntity {
	...
	public void setOperationListMap (OperationsObject operationsObject , Class< ? > clazz) {
		...
		Operation defaults,string, hash , list,set,sortedSet,pubSub,script;
	...
	public boolean isEntity() {
		if(this.string == null && this.hash == null && this.list == null && this.set == null && this.sortedSet == null) {
			return false;
		}
		return true;
