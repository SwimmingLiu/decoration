...
import com.lamp.foundation.api.http.multipart.MultipartUpload.MultipartUploadBuilder;
import com.lamp.foundation.api.http.request.Coordinate;

public interface CoordinateHandler<T, V> {

	ThreadLocal<CoordinateHandlerWrapper> COORDINATEHANDLER = ThreadLocal.withInitial(CoordinateHandlerWrapper::new);
	...
	abstract class AbstractCoordinateHandler<T, V> implements CoordinateHandler<T, V> {
	...
	class CookieCoordinateHandler extends AbstractCoordinateHandler<HttpHeaders, String> {
		@Override
	...
	class HeaderCoordinateHandler extends AbstractCoordinateHandler<HttpHeaders, String> {
		@Override
		public void handler(String name, String value) {
	...
	class PathCoordinateHandler extends AbstractCoordinateHandler<Map<String, String>, String> {
		@Override
		public void handler(String name, String value) {
	...
	class QueryCoordinateHandler extends AbstractCoordinateHandler<QueryStringEncoder, String> {
		@Override
		public void handler(String name, String value) {
	...
	class FieldCoordinateHandler extends AbstractCoordinateHandler<HttpPostRequestEncoder, String> {
		@Override
		public void handler(String name, String value) {
			try {
	...
	class UploadCoordinateHandler extends AbstractCoordinateHandler<HttpPostRequestEncoder, Object> {
	...
	class CoordinateHandlerWrapper {
