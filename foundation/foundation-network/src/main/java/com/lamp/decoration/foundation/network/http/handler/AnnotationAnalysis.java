...
import com.lamp.foundation.api.call.Call;
import com.lamp.foundation.api.http.annotation.method.DELETE;
import com.lamp.foundation.api.http.annotation.method.GET;
import com.lamp.foundation.api.http.annotation.method.HEAD;
import com.lamp.foundation.api.http.annotation.method.OPTIONS;
import com.lamp.foundation.api.http.annotation.method.PATCH;
import com.lamp.foundation.api.http.annotation.method.POST;
import com.lamp.foundation.api.http.annotation.method.PUT;
import com.lamp.foundation.api.http.annotation.parameter.Body;
import com.lamp.foundation.api.http.annotation.parameter.Cookie;
import com.lamp.foundation.api.http.annotation.parameter.Field;
import com.lamp.foundation.api.http.annotation.parameter.Header;
import com.lamp.foundation.api.http.annotation.parameter.Headers;
import com.lamp.foundation.api.http.annotation.parameter.Multipart;
import com.lamp.foundation.api.http.annotation.parameter.Path;
import com.lamp.foundation.api.http.annotation.parameter.Query;
import com.lamp.foundation.api.http.multipart.MultipartUpload;
...
import com.lamp.foundation.base.extension.serialize.FastJson2Serialize;
        ...
        if (Objects.nonNull(post) || Objects.nonNull(put) ) {
            ...
            if (Objects.nonNull(body)) {
                ...
                if (serializeClass.equals(Serialize.class)) {
                    serialize = new FastJson2Serialize();
                } else {
