 ...
 *
 */
public interface ListCommandsElement {
	
	/**
	 *  Blpop 命令移出并获取列表的第一个元素， 如果列表没有元素会阻塞列表直到等待超时或发现可弹出元素为止。
	 */
	public static final CombinationElement BLPOP_SINGLE     =  CombinationElement.newCombinationElement(  3 , "blpop"          ,  ResolveNetProtocol.listBlockNetProtocol);
	 ...
	 */
	public static final CombinationElement BRPOP_SINGLE     =  CombinationElement.newCombinationElement(  3 , "brpop"          ,  ResolveNetProtocol.listBlockNetProtocol );
	 ...
	 */
	public static final CombinationElement BRPOPLPUSH       =  CombinationElement.newCombinationElement(  3 , "brpoplpush"     , false ,  ResolveNetProtocol.listBlockNetProtocol);
