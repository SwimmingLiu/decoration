package com.lamp.decoration.foundation.network.redis.configuration;


import com.lamp.decoration.foundation.network.redis.exception.ConfigureException;
import com.lamp.decoration.foundation.network.redis.utils.BasicAttributes;
...
public class SingleConfiguration {
	...
	public static class SingleConfigurationBuilder{
		...
		public SingleConfigurationBuilder() {
			super( ) ;
		}
		
		public SingleConfigurationBuilder(
				String name, String host, int post, int select, int connectionMode, int netMode, int connectionNum,
				int keepAliveTime
		) {
			super( ) ;
			this.name = name ;
