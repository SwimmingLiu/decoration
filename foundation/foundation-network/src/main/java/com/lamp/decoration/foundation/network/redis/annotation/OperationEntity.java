...
public class OperationEntity {
	...
	public String toString() {
		return "OperationEntity [name=" + name + ", prefix=" + prefix + ", separator=" + separator + ", key=" + key
				+ ", combinationKey=" + combinationKey + ", mapPrefix=" + mapPrefix + ", mapKey=" + mapKey
				+ ", dataSource=" + dataSource + ", pattern=" + Arrays.toString(pattern) + ", sliceKey=" + sliceKey
				+ ", clazz=" + clazz + ", value=" + value + ", commands=" + commands + "]";
	}
